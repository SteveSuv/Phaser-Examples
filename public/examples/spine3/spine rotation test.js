class Example extends Phaser.Scene {
  ...
  create() {
    ...
    for (let a = 0; a < 360; a += 22.5) {
      ...
      const p = Phaser.Geom.Circle.CircumferencePoint(
        circle,
      ...
      const lp = Phaser.Geom.Circle.CircumferencePoint(
        labelCircle,
        Phaser.Math.DegToRad(a),
      );
    ...
    for (let a = 0; a < 360; a += 22.5) {
      const newa = Phaser.Math.RadToDeg(
        Phaser.Math.Angle.CounterClockwise(Phaser.Math.DegToRad(a)),
      );
