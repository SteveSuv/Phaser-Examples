class Example extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load
      .setPath("assets/spine/3.8/raptor")
      .spine("raptor", "raptor-pro.json", "raptor-pro.atlas");
    this.load
      .setPath("assets/spine/3.8/vine")
      .spine("vine", "vine-pro.json", "vine-pro.atlas");
    this.load
      .setPath("assets/spine/3.8/coin")
      .spine("coin", "coin-pro.json", "coin-pro.atlas");
    this.load
      .setPath("assets/spine/3.8/tank")
      .spine("tank", "tank-pro.json", "tank-pro.atlas");
  }
