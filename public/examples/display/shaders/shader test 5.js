...
class Example extends Phaser.Scene {
  ...
  preload() {
    this.load.image(
      "pic",
      "assets/pics/rick-and-morty-by-sawuinhaff-da64e7y.png",
    );
  ...
  create() {
    ...
    const maskImage1 = this.make.image({
      x: 400,
      y: 300,
      key: "splat1",
      add: false,
    ...
    const maskImage3 = this.make.image({
      x: 400,
      y: 300,
      key: "splat3",
      add: false,
    });
    const maskImage4 = this.make.image({
      x: 400,
      y: 300,
      key: "bunny",
      add: false,
    ...
    const baseShader1 = new Phaser.Display.BaseShader(
      "BufferShader1",
      fragmentShader,
    );
    ...
    const baseShader4 = new Phaser.Display.BaseShader(
      "BufferShader4",
      fragmentShader3,
    );
    const baseShader5 = new Phaser.Display.BaseShader(
      "BufferShader5",
      fragmentShader4,
    );
