...
class Example extends Phaser.Scene {
  ...
  create() {
    ...
    const basesShader2 = new Phaser.Display.BaseShader(
      "BufferShader2",
      fragmentShader3,
    );
    const basesShader3 = new Phaser.Display.BaseShader(
      "BufferShader3",
      fragmentShader6,
    );
    ...
    const shader2 = this.add
      .shader(basesShader2, 400, 300, 256, 256)
      .setVisible(false);
    ...
    this.input.on("pointerdown", function (pointer) {
      if (shader2.visible) {
        const actualShader =
          shader2.shader.key === "BufferShader3" ? basesShader2 : basesShader3;
