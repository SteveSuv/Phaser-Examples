class WorldMap extends Phaser.Scene {
  ...
  create() {
    ...
    const planet1 = this.physics.add
      .image(100, 100, "space", "blue-planet")
      .setScale(0.15)
      .setSize(360, 360)
      .setOffset(400, 400);
    const planet2 = this.physics.add
      .image(600, 0, "space", "brown-planet")
      .setScale(0.2)
      .setSize(360, 360)
      .setOffset(400, 500);
    const planet3 = this.physics.add
      .image(300, 700, "space", "gas-giant")
      .setScale(0.2)
      .setSize(360, 360)
      .setOffset(450, 500);
    const planet4 = this.physics.add
      .image(1200, 500, "space", "purple-planet")
      .setScale(0.3)
      .setSize(360, 360)
      .setOffset(400, 400);
    ...
    this.add
      .text(10, 10, "Cursors to move. Fly into the planets.", {
        font: "16px Courier",
        fill: "#00ff00",
      })
      .setScrollFactor(0);
