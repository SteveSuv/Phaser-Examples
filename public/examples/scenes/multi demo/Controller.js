class Controller extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      "boing",
      "assets/phaser3/boing.png",
      "assets/phaser3/boing.json",
    );

    this.load.spritesheet("juggler", "assets/phaser3/juggler.png", {
      frameWidth: 128,
      frameHeight: 184,
    });
    ...
    this.load.spritesheet("invaders.bullet", "assets/games/multi/bullet.png", {
      frameWidth: 12,
      frameHeight: 14,
    });
    ...
    this.load.spritesheet(
      "invaders.invader1",
      "assets/games/multi/invader1.png",
      { frameWidth: 16, frameHeight: 16 },
    );
    this.load.spritesheet(
      "invaders.invader2",
      "assets/games/multi/invader2.png",
      { frameWidth: 22, frameHeight: 16 },
    );
    this.load.spritesheet(
      "invaders.invader3",
      "assets/games/multi/invader3.png",
  ...
  create() {
    ...
    this.workbenchIcons = this.add
      .image(this.sys.game.config.width - 87, 21, "workbenchIcons")
      .setOrigin(0);
    ...
    const eyesIcon = this.add
      .image(32, 34, "eyesIcon", 0)
      .setOrigin(0)
      .setInteractive();
    const jugglerIcon = this.add
      .image(48, 110, "jugglerIcon", 0)
      .setOrigin(0)
      .setInteractive();
    const starsIcon = this.add
      .image(230, 40, "starsIcon", 0)
      .setOrigin(0)
      .setInteractive();
    const invadersIcon = this.add
      .image(120, 34, "invadersIcon", 0)
      .setOrigin(0)
      .setInteractive();
    const clockIcon = this.add
      .image(240, 120, "clockIcon", 0)
      .setOrigin(0)
      .setInteractive();
    const boingIcon = this.add
      .image(146, 128, "boingIcon", 0)
      .setOrigin(0)
      .setInteractive();

    const demosContainer = this.add.container(32, 70, [
      demosWindow,
      eyesIcon,
      jugglerIcon,
      starsIcon,
    ...
    demosContainer.setInteractive(
      new Phaser.Geom.Rectangle(0, 0, demosWindow.width, demosWindow.height),
  ...
  createWindow(func) {
    ...
    const win = this.add
      .zone(x, y, func.WIDTH, func.HEIGHT)
      .setInteractive()
      .setOrigin(0);
