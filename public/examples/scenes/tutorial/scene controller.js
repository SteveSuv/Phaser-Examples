class Controller extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      "space",
      "assets/tests/scenes/space.png",
      "assets/tests/scenes/space.json",
    );
    this.load.atlas(
      "ui",
      "assets/tests/scenes/ui.png",
      "assets/tests/scenes/ui.json",
    );
    this.load.bitmapFont(
      "digital",
      "assets/tests/scenes/digital.png",
      "assets/tests/scenes/digital.xml",
    );
  }

  create() {
    this.textures.addSpriteSheetFromAtlas("mine", {
      atlas: "space",
      frame: "mine",
      frameWidth: 64,
    });
    this.textures.addSpriteSheetFromAtlas("asteroid", {
      atlas: "space",
      frame: "asteroid",
      frameWidth: 96,
    });
    ...
    //  LCD
    this.text1 = this.add
      .bitmapText(520, 42, "digital", "nebula", 32)
      .setOrigin(0.5, 0)
      .setAlpha(0.8);
    this.text2 = this.add
      .bitmapText(520, 74, "digital", "index 1 / 6", 22)
      .setOrigin(0.5, 0)
      .setAlpha(0.8);
...
class SceneE extends Phaser.Scene {
  constructor() {
    ...
    this.splineData = [
      50, 300, 146, 187, 35, 94, 180, 40, 446, 35, 438, 100, 337, 150, 452, 185,
      560, 155, 641, 90, 723, 147, 755, 262, 651, 271, 559, 318, 620, 384, 563,
      469, 433, 457, 385, 395, 448, 334, 406, 265, 316, 305, 268, 403, 140, 397,
      205, 309, 204, 240, 144, 297, 50, 300,
    ];
