class Controller extends Phaser.Scene {
  ...
  create() {
    ...
    var eyesIcon = this.add
      .image(32, 34, "eyesIcon", 0)
      .setOrigin(0)
      .setInteractive();
    var jugglerIcon = this.add
      .image(64, 110, "jugglerIcon", 0)
      .setOrigin(0)
      .setInteractive();
    var starsIcon = this.add
      .image(230, 40, "starsIcon", 0)
      .setOrigin(0)
      .setInteractive();
    var invadersIcon = this.add
      .image(120, 34, "invadersIcon", 0)
      .setOrigin(0)
      .setInteractive();
    var clockIcon = this.add
      .image(200, 120, "clockIcon", 0)
      .setOrigin(0)
      .setInteractive();

    var demosContainer = this.add.container(32, 70, [
      demosWindow,
      eyesIcon,
      jugglerIcon,
      starsIcon,
...
class Eyes extends Phaser.Scene {
  ...
  create() {
    ...
    this.rightBase = new Phaser.Geom.Ellipse(
      this.right.x,
      this.right.y,
      24,
      40,
  ...
  update() {
    ...
    if (this.leftBase.contains(this.leftTarget.x2, this.leftTarget.y2)) {
      ...
      Phaser.Geom.Ellipse.CircumferencePoint(
        this.leftBase,
        Phaser.Geom.Line.Angle(this.leftTarget),
        this.mid,
      );
    }
    ...
    if (this.rightBase.contains(this.rightTarget.x2, this.rightTarget.y2)) {
      ...
      Phaser.Geom.Ellipse.CircumferencePoint(
        this.rightBase,
        Phaser.Geom.Line.Angle(this.rightTarget),
        this.mid,
      );
    }
