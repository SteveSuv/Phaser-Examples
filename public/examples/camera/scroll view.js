...
class Example extends Phaser.Scene {
  ...
  update() {
    ...
    horizontalCamera.scrollX =
      (halfWidth - quarterWidth + Math.cos(iter) * quarterWidth) | 0;
    verticalCamera.scrollY =
      (halfHeight - quarterHeight + Math.sin(iter) * quarterHeight) | 0;
    circularCamera.scrollX =
      (halfWidth - quarterWidth + Math.cos(iter) * quarterWidth) | 0;
    circularCamera.scrollY =
      (halfHeight - quarterHeight + Math.sin(iter) * quarterHeight) | 0;
