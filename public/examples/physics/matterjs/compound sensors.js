class Example extends Phaser.Scene {
  ...
  create() {
    ...
    const circleA = Bodies.circle(-70, 0, 24, {
      isSensor: true,
      label: "left",
    });
    const circleB = Bodies.circle(70, 0, 24, {
      isSensor: true,
      label: "right",
    });
    const circleC = Bodies.circle(0, -70, 24, { isSensor: true, label: "top" });
    const circleD = Bodies.circle(0, 70, 24, {
      isSensor: true,
      label: "bottom",
    });
    ...
    this.add.text(10, 10, "Move with cursor keys. Hit blocks with sensors.", {
      font: "16px Courier",
      fill: "#ffffff",
    });
  }
