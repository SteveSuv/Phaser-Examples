...
class Example extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("enemy", "assets/sprites/metalface78x92.png", {
      frameWidth: 78,
      frameHeight: 92,
    });
    this.load.unityAtlas(
      "asteroids",
      "assets/atlas/asteroids.png",
      "assets/atlas/asteroids.png.meta",
    );
  }
  ...
  create() {
    ...
    this.ship = this.matter.add.image(400, 300, "ship", null, {
      plugin: wrapBounds,
    });
