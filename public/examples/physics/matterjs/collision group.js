class Example extends Phaser.Scene {
  ...
  create() {
    ...
    const block1 = this.matter.add
      .image(400, 450, "strip")
      .setStatic(true)
      .setCollisionGroup(group1);
    const fish1 = this.matter.add
      .image(100, 100, "fish", 0)
      .setBounce(1)
      .setFriction(0, 0, 0)
      .setCollisionGroup(group1)
      .setVelocityY(10);
    ...
    const block2 = this.matter.add
      .image(400, 400, "strip")
      .setStatic(true)
      .setCollisionGroup(group2);
    const fish2 = this.matter.add
      .image(250, 100, "fish", 1)
      .setBounce(1)
      .setFriction(0, 0, 0)
      .setCollisionGroup(group2)
      .setVelocityY(10);
    ...
    const block3 = this.matter.add
      .image(400, 500, "strip")
      .setStatic(true)
      .setCollisionCategory(cat1)
      .setCollidesWith(cat1);
    const fish3 = this.matter.add
      .image(450, 100, "fish", 2)
      .setBounce(1)
      .setFriction(0, 0, 0)
      .setVelocityY(10)
      .setCollisionCategory(cat1)
