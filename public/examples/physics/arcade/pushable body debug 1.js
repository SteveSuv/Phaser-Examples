class Example extends Phaser.Scene {
  ...
  create() {
    ...
    const test1A = this.physics.add
      .image(80, 500, "blockAP")
      .setCollideWorldBounds()
      .setInteractive();
    const test1B = this.physics.add
      .image(80, 150, "blockBP")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test2A = this.physics.add
      .image(208, 500, "blockANP")
      .setCollideWorldBounds()
      .setInteractive();
    const test2B = this.physics.add
      .image(208, 150, "blockBNP")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test3A = this.physics.add
      .image(336, 500, "blockAP")
      .setCollideWorldBounds()
      .setInteractive();
    const test3B = this.physics.add
      .image(336, 150, "blockBNP")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test4A = this.physics.add
      .image(464, 500, "blockANP")
      .setCollideWorldBounds()
      .setInteractive();
    const test4B = this.physics.add
      .image(464, 150, "blockBP")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test5A = this.physics.add
      .image(592, 500, "blockAP")
      .setCollideWorldBounds()
      .setInteractive();
    const test5B = this.physics.add
      .image(592, 150, "blockBNM")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test6A = this.physics.add
      .image(720, 500, "blockANP")
      .setCollideWorldBounds()
      .setInteractive();
    const test6B = this.physics.add
      .image(720, 150, "blockBNM")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test7A = this.physics.add
      .image(848, 500, "blockANM")
      .setCollideWorldBounds()
      .setInteractive();
    const test7B = this.physics.add
      .image(848, 150, "blockBP")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test8A = this.physics.add
      .image(976, 500, "blockANM")
      .setCollideWorldBounds()
      .setInteractive();
    const test8B = this.physics.add
      .image(976, 150, "blockBNP")
      .setCollideWorldBounds()
      .setInteractive();
