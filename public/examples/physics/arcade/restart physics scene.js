...
class Game extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .text(0, 0, "Use Cursors to scroll camera.\nClick to Quit", {
        font: "18px Courier",
        fill: "#00ff00",
      })
      .setScrollFactor(0);

    this.text = this.add.text(400, 0, "", {
      font: "16px Courier",
      fill: "#00ff00",
    });
  ...
  update(time, delta) {
    ...
    this.text.setText([`x: ${this.track.x}`, `y: ${this.track.y}`]);
  }
}
...
class GameOver extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(300, 500, "Game Over - Click to start restart", {
      font: "16px Courier",
      fill: "#00ff00",
    });
