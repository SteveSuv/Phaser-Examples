class Example extends Phaser.Scene {
  ...
  create() {
    ...
    const test1A = this.physics.add
      .image(200, 100 - 16, "blockAP")
      .setCollideWorldBounds()
      .setInteractive();
    const test1B = this.physics.add
      .image(600, 100 - 16, "blockBP")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test2A = this.physics.add
      .image(200, 196 - 16, "blockANP")
      .setCollideWorldBounds()
      .setInteractive();
    const test2B = this.physics.add
      .image(600, 196 - 16, "blockBNP")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test3A = this.physics.add
      .image(200, 292 - 16, "blockAP")
      .setCollideWorldBounds()
      .setInteractive();
    const test3B = this.physics.add
      .image(600, 292 - 16, "blockBNP")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test4A = this.physics.add
      .image(200, 388 - 16, "blockANP")
      .setCollideWorldBounds()
      .setInteractive();
    const test4B = this.physics.add
      .image(600, 388 - 16, "blockBP")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test5A = this.physics.add
      .image(200, 484 - 16, "blockAP")
      .setCollideWorldBounds()
      .setInteractive();
    const test5B = this.physics.add
      .image(600, 484 - 16, "blockBNM")
      .setCollideWorldBounds()
      .setInteractive();
    ...
    const test6A = this.physics.add
      .image(200, 580 - 16, "blockANP")
      .setCollideWorldBounds()
      .setInteractive();
    const test6B = this.physics.add
      .image(600, 580 - 16, "blockBNM")
      .setCollideWorldBounds()
      .setInteractive();
