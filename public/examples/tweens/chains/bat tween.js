class Bat extends Phaser.GameObjects.Container {
  constructor(scene, x, y) {
    ...
    const wing1 = scene.add
      .image(-50, 10, "assets", "Wing02_01")
      .setOrigin(1, 0.5);
    const wing2 = scene.add
      .image(50, 10, "assets", "Wing02_02")
      .setOrigin(0, 0.5);
    ...
    body.setInteractive(
      new Phaser.Geom.Circle(170, 170, 100),
...
class Example extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      "assets",
      "assets/atlas/tweenparts.png",
      "assets/atlas/tweenparts.json",
    );
  }
