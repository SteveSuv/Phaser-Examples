class Example extends Phaser.Scene {
  ...
  create() {
    ...
    const b1 = this.textures.addSpriteSheetFromAtlas("bubble1", {
      atlas: "testanims",
      frame: "bubble-notrim",
      frameWidth: 34,
      frameHeight: 68,
    ...
    const b2 = this.textures.addSpriteSheetFromAtlas("bubble2", {
      atlas: "testanims",
      frame: "bubble",
      frameWidth: 34,
      frameHeight: 68,
    ...
    const config1 = {
      key: "explode1",
      frames: this.anims.generateFrameNumbers("boom1", {
        start: 0,
        end: 23,
        first: 23,
      }),
    ...
    const config2 = {
      key: "explode2",
      frames: this.anims.generateFrameNumbers("boom2", {
        start: 0,
        end: 23,
        first: 23,
      }),
