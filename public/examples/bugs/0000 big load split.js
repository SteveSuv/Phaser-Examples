    ...
    if (Phaser.VERSION === "3.55.2") {
      ...
      button5.once("pointerdown", () => {
        window.location.href =
          "https://labs.phaser.io/view.html?src=src/bugs/0000%20big%20load.js&v=live";
      });
    } else {
      ...
      button5.once("pointerdown", () => {
        window.location.href =
          "https://labs.phaser.io/view.html?src=src/bugs/0000%20big%20load.js&v=3.55.2";
      });
    }
  }
}
...
class Demo extends Phaser.Scene {
  ...
  init(data) {
    ...
    this.add.text(10, 10, `Loading ${this.quantity} files`, {
      font: "20px Courier",
      fill: "#00ff00",
    });
  ...
  preload() {
    ...
    for (let i = 0; i < this.quantity; i++) {
      this.load.image(
        `block${i}`,
        "https://labs.phaser.io/assets/sprites/128x128-v2.png",
      );
    }
  }
