class SetQuantity extends Phaser.Scene {
  ...
  create() {
    ...
    const button1 = this.add.text(10, 100, "2500", {
      fontFamily: "Arial",
      fontSize: "24px",
      color: "#ffffff",
      align: "center",
    ...
    const button2 = this.add.text(10, 200, "5000", {
      fontFamily: "Arial",
      fontSize: "24px",
      color: "#ffffff",
      align: "center",
    ...
    const button3 = this.add.text(10, 300, "7500", {
      fontFamily: "Arial",
      fontSize: "24px",
      color: "#ffffff",
      align: "center",
    ...
    const button4 = this.add.text(10, 400, "10000", {
      fontFamily: "Arial",
      fontSize: "24px",
      color: "#ffffff",
      align: "center",
    ...
    if (Phaser.VERSION === "3.55.2") {
      ...
      button5.once("pointerdown", () => {
        window.location.href =
          "https://labs.phaser.io/view.html?src=src/bugs/0000%20big%20load%20tiny.js&v=live";
      });
    } else {
      ...
      button5.once("pointerdown", () => {
        window.location.href =
          "https://labs.phaser.io/view.html?src=src/bugs/0000%20big%20load%20tiny.js&v=3.55.2";
      });
    }
  }
}
...
class Demo extends Phaser.Scene {
  ...
  init(data) {
    ...
    this.add.text(10, 10, `Loading ${this.quantity} 2x2 files`, {
      font: "20px Courier",
      fill: "#00ff00",
    });
  ...
  preload() {
    ...
    for (let i = 0; i < this.quantity; i++) {
      this.load.image(
        `block${i}`,
        `https://labs.phaser.io/assets/tests/pixels/${p}.png`,
      );
