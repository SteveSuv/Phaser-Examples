class TestScene extends Phaser.Scene {
  create() {
    ...
    this.runCounter = this.add.text(500, 300, "Click to Run", {
      fill: "orange",
    });
  ...
  resizeTest() {
    ...
    this.add.text(
      500,
      120,
      "After adding texture: " + this.getMemoryInfo() + " MB",
    );
    ...
    this.add.text(
      500,
      180,
      "After resizing texture to 0x0: " + this.getMemoryInfo() + " MB",
    );
    ...
    this.add.text(
      500,
      240,
      "After resizing texture to 2048x2048: " + this.getMemoryInfo() + " MB",
    );
  ...
  getMemoryInfo() {
    const totalMemoryInfo = this.game.renderer.gl
  ...
  update() {
    ...
    this.current.setText([
      ...
      "Current texture: " +
        Math.round(info.memory.texture / 1024 / 1024) +
        " MB",
      "Current renderbuffer: " +
        Math.round(info.memory.renderbuffer / 1024 / 1024) +
        " MB",
      "Current drawingbuffer: " +
        Math.round(info.memory.drawingbuffer / 1024 / 1024) +
        " MB",
      "Current total: " + Math.round(info.memory.total / 1024 / 1024) + " MB",
      "Total minus Initial: " +
        (Math.round(info.memory.total / 1024 / 1024) - this.initial) +
        " MB",
    ]);
