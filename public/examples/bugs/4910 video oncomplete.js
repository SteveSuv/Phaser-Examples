...
function preload() {
  ...
  this.load.video(
    "underwater",
    "assets/video/underwater.mp4",
    "canplaythrough",
    false,
  );
  this.load.video(
    "pumpkins",
    "assets/video/pumpkins.mp4",
    "canplaythrough",
    false,
  );
  this.load.video(
...
function create() {
  ...
  vid2 = this.add
    ...
    .setAlpha(0.1);
  vid3 = this.add
    .video(0, 300, "mountains")
    .setScale(0.5)
    .setOrigin(0)
    .setAlpha(0.1);
  vid4 = this.add
    .video(400, 300, "pumpkins")
    .setScale(0.5)
    .setOrigin(0)
    .setAlpha(0.1);
...
function update() {
  debug1.setText([vid1.video.paused]);

  debug2.setText([vid2.video.paused]);

  debug3.setText([vid3.video.paused]);

  debug4.setText([vid4.video.paused]);
}
