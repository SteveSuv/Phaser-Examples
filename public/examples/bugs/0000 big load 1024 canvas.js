class SetQuantity extends Phaser.Scene {
  ...
  create() {
    this.add.text(
      10,
      10,
      `Phaser v${Phaser.VERSION}\n1024 CANVAS TEST\nSelect quantity to load`,
      { font: "16px Courier", fill: "#00ff00" },
    );

    const button1 = this.add.text(10, 100, "10", {
      fontFamily: "Arial",
      fontSize: "24px",
      color: "#ffffff",
      align: "center",
    ...
    const button2 = this.add.text(10, 200, "50", {
      fontFamily: "Arial",
      fontSize: "24px",
      color: "#ffffff",
      align: "center",
    ...
    const button3 = this.add.text(10, 300, "100", {
      fontFamily: "Arial",
      fontSize: "24px",
      color: "#ffffff",
      align: "center",
    ...
    const button4 = this.add.text(10, 400, "250", {
      fontFamily: "Arial",
      fontSize: "24px",
      color: "#ffffff",
      align: "center",
    ...
    if (Phaser.VERSION === "3.55.2") {
      const button5 = this.add.text(10, 500, "Swap to 3.61", {
        fontFamily: "Arial",
        fontSize: "24px",
        color: "#000000",
        align: "center",
      ...
      button5.once("pointerdown", () => {
        window.location.href =
          "https://labs.phaser.io/view.html?src=src/bugs/0000%20big%20load%201024.js&v=live";
      });
    } else {
      const button5 = this.add.text(10, 500, "Swap to 3.55", {
        fontFamily: "Arial",
        fontSize: "24px",
        color: "#000000",
        align: "center",
      ...
      button5.once("pointerdown", () => {
        window.location.href =
          "https://labs.phaser.io/view.html?src=src/bugs/0000%20big%20load%201024.js&v=3.55.2";
      });
    }
  }
}
...
class Demo extends Phaser.Scene {
  ...
  init(data) {
    ...
    this.add.text(10, 10, `Loading ${this.quantity} 1024px files`, {
      font: "16px Courier",
      fill: "#00ff00",
    });
  ...
  preload() {
    ...
    for (let i = 0; i < this.quantity; i++) {
      this.load.image(
        `block${i}`,
        `https://labs.phaser.io/assets/pics/sao-sinon.png`,
      );
    }
  }
  ...
  create() {
    ...
    this.add
      .image(128, 328, `block${this.quantity - 1}`)
      .setOrigin(0)
      .setScale(0.25);
  }
}
