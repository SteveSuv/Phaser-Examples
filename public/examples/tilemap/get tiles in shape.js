class Example extends Phaser.Scene {
  ...
  update(time, delta) {
    ...
    if (this.p1) {
      this.graphics.fillCircle(this.p1.x, this.p1.y, 3);
    }
    if (this.p2) {
      this.graphics.fillCircle(this.p2.x, this.p2.y, 3);
    }
    ...
    if (this.p1 && this.p2) {
      ...
      switch (this.selectedShape) {
        case "rectangle": {
          ...
          overlappingTiles = this.map.getTilesWithinShape(rect, {
            isColliding: this.onlyColliding,
          });
        ...
        case "line": {
          ...
          overlappingTiles = this.map.getTilesWithinShape(line, {
            isColliding: this.onlyColliding,
          });
        ...
        case "circle": {
          ...
          overlappingTiles = this.map.getTilesWithinShape(circle, {
            isColliding: this.onlyColliding,
          });
        ...
        case "triangle": {
          ...
          overlappingTiles = this.map.getTilesWithinShape(tri, {
            isColliding: this.onlyColliding,
          });
