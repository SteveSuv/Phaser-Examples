class Example extends Phaser.Scene {
  ...
  create() {
    ...
    this.sourceMarker = this.add.graphics({
      lineStyle: { width: 5, color: 0xffffff, alpha: 1 },
    });
    this.sourceMarker.strokeRect(
      0,
      0,
      6 * this.map.tileWidth,
      6 * this.map.tileHeight,
    );
    ...
    this.destinationMarker.strokeRect(
      0,
      0,
      6 * this.map.tileWidth,
      6 * this.map.tileHeight,
    ...
    this.destinationMarker.setPosition(
      this.map.tileWidth * 5,
      this.map.tileHeight * 10,
    );
