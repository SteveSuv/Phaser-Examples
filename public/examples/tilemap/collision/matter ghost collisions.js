class Example extends Phaser.Scene {
  ...
  preload() {
    this.load.tilemapTiledJSON(
      "map",
      "assets/tilemaps/maps/matter-ghost-vertices.json",
    );
    this.load.image(
      "kenney_redux_64x64",
  ...
  create() {
    ...
    const rect = this.map.findObject(
      "Collision",
      (obj) => obj.name === "Stone Platform",
    );
    ...
    this.time.addEvent({
      ...
      callback: function () {
        ...
        this.time.addEvent({
          delay: 2000,
          callback: this.destroyShroom.bind(this, shroom1),
        });
        ...
        this.time.addEvent({
          delay: 2000,
          callback: this.destroyShroom.bind(this, shroom2),
        });
      },
      callbackScope: this,
      loop: true,
