class Example extends Phaser.Scene {
  ...
  create() {
    ...
    this.createSlider(
      ...
      360,
      0,
      this.curve.setRotation,
    );

    const centerPoint = this.add
      .image(this.curve.p0.x, this.curve.p0.y, "dragcircle", 0)
      .setInteractive();
    centerPoint
      .setData("control", "center")
      .setData("vector", this.curve.p0)
      .setName("centerpoint");
  ...
  createSlider(graphics, x, y, label, width, min, max, value, callback) {
    ...
    this.text = this.add
      .text(x - 10, y, label + ":", { font: "16px Courier", fill: "#00ff00" })
      .setOrigin(1, 0);
    const textValue = this.add.text(x + width + 10, y, value.toFixed(2), {
      font: "16px Courier",
      fill: "#00ff00",
    });
