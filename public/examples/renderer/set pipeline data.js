...
export default class Example extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .sprite(100, 300, "pudding")
      .setPipeline(multiColorPipeline, { effect: 0, gray: 0.75 });
    this.add
      .sprite(400, 300, "crab")
      .setScale(1.5)
      .setPipeline(multiColorPipeline, { effect: 1, speed: 0.001 });
    this.fish = this.add
      .sprite(400, 300, "fish")
      .setPipeline(multiColorPipeline, { effect: 1, speed: 0.005 });
    this.add
      .sprite(700, 300, "cake")
      .setPipeline(multiColorPipeline, { effect: 0, gray: 1 });
