class Example extends Phaser.Scene {
  preload() {
    this.load.spritesheet("invader1", "assets/tests/invaders/invader1.png", {
      frameWidth: 32,
      frameHeight: 32,
    });
    this.load.spritesheet("invader2", "assets/tests/invaders/invader2.png", {
      frameWidth: 44,
      frameHeight: 32,
    });
    this.load.spritesheet("invader3", "assets/tests/invaders/invader3.png", {
      frameWidth: 48,
      frameHeight: 32,
    });
  }
    ...
    const invader2 = this.add.group([
      {
        ...
        frame: 0,
        repeat: 10,
        setXY: { x: 32, y: 148, stepX: 52 },
      },
      {
        key: "invader2",
        frame: 0,
        repeat: 10,
        setXY: { x: 32, y: 148 + 48, stepX: 52 },
      },
    ]);
    ...
    const invader3 = this.add.group([
      {
        ...
        frame: 0,
        repeat: 9,
        setXY: { x: 32, y: 148 + 96, stepX: 58 },
      },
      {
        key: "invader3",
        frame: 0,
        repeat: 9,
        setXY: { x: 32, y: 148 + 96 + 48, stepX: 58 },
      },
    ]);
