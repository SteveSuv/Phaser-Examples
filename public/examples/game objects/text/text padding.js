class Example extends Phaser.Scene {
  create() {
    ...
    this.add
      .text(100, 310, "Phaser", style)
      .setPadding({ y: 16, left: 48, right: 128 });

    //  32px horizontal padding, 4px on the top and 16px on the bottom
    this.add
      .text(100, 410, "Phaser", style)
      .setPadding({ x: 32, top: 4, bottom: 16 });

    //  Different values for each side
    this.add
      .text(100, 510, "Phaser", style)
      .setPadding({ left: 8, right: 128, top: 0, bottom: 32 });
  }
}
