class Example extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      "ui",
      "assets/rope/ui-icons.png",
      "assets/rope/ui-icons.json",
    );
  }
  ...
  create() {
    ...
    this.add
      .text(10, 10, "Click the arrows to flip", {
        font: "16px Courier",
        fill: "#000000",
      })
      .setShadow(1, 1, "#ffffff");

    const rope = this.add.rope(400, 300, "dog", null, 12);

    const hFlip = this.add
      .image(80, 600 - 64, "ui", "forward-pink")
      .setInteractive();
    const vFlip = this.add
      .image(800 - 70, 600 - 80, "ui", "forward-pink")
      .setAngle(-90)
      .setInteractive();
