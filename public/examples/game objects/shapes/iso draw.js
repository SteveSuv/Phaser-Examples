class Example extends Phaser.Scene {
  ...
  create() {
    ...
    this.swatchData = this.textures.createCanvas(
      "swatch",
      src.width,
      src.height,
    );
  ...
  pxToMap(screenX, screenY) {
    ...
    const x =
      ((screenY * 2) / this.TILE_HEIGHT + screenX / this.TILE_WIDTH) / 2;
