class Example extends Phaser.Scene {
  ...
  create() {
    ...
    this.test1 = this.add
      .text(400, 50, "Phaser 3", { fontSize: 32 })
      .setOrigin(0.5);

    //  Test 2
    //  Render object at given coordinates factoring in origin 1
    this.test2 = this.add
      .text(400, 150, "Phaser 3", { fontSize: 32 })
      .setOrigin(1, 0.5);
    ...
    this.test4 = this.add
      .text(400, 250, "Phaser 3", { fontSize: 32 })
      .setOrigin(0.5)
      .setScale(2);
    ...
    this.test5 = this.add
      .text(400, 350, "Phaser 3", { fontSize: 32 })
      .setOrigin(0.5);

    //  Test 6
    //  Render object with alpha
    this.test6 = this.add
      .text(400, 450, "Phaser 3", { fontSize: 32 })
      .setOrigin(0.5)
      .setAlpha(0.5);
    ...
    this.test7 = this.add
      .text(400, 550, "Phaser 3", { fontSize: 32 })
      .setOrigin(0.5)
      .setBlendMode(1);
  }
