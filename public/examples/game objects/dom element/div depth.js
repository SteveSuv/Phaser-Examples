class Example extends Phaser.Scene {
  ...
  create() {
    ...
    div1.style =
      "background-color: lime; width: 220px; height: 100px; font: 48px Arial; font-weight: bold";
    div1.innerText = "Phaser 3";

    const div2 = document.createElement("div");
    div2.style =
      "background-color: yellow; width: 220px; height: 100px; font: 48px Arial; font-weight: bold";
