class Example extends Phaser.Scene {
  ...
  create() {
    ...
    const mouth = this.add
      .image(-58, -114, "girl", "MouthOpen")
      .setName("mouth");
    const braidLeft = this.add
      .image(14, -74, "girl", "BraidLeft")
      .setName("braidLeft");
    const braidRight = this.add
      .image(98, -72, "girl", "BraidRight")
      .setName("braidRight");
    const armLeft = this.add
      .image(-48, -62, "girl", "ArmLeft")
      .setName("armLeft")
      .setOrigin(1, 0.5);
    const armRight = this.add
      .image(26, 28, "girl", "ArmRight")
      .setName("armRight");
