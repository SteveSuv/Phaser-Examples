  ...
  create() {
    ...
    for (let i = 0; i < 1024; i++) {
      ...
      const image = layer.add(
        this.make.image({ x, y, key: "atlas", frame: "veg0" + f }, false),
      );

      image.depth = image.y;
    }

    this.mushroom0 = layer.add(
      this.make.image({ x: 400, y: 300, key: "mushroom" }, false),
    );
    this.mushroom1 = layer.add(
      this.make.image({ x: 400, y: 300, key: "mushroom" }, false),
    );
    this.mushroom2 = layer.add(
      this.make.image({ x: 400, y: 300, key: "mushroom" }, false),
    );
