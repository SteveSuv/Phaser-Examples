class Example extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.obj(
      "roadStart",
      "roadStartPositions.obj",
      "roadStartPositions.mtl",
    );
    ...
    this.load.obj(
      "roadStraightLong",
      "roadStraightLong.obj",
      "roadStraightLong.mtl",
    );
    this.load.obj(
      "roadStraightArrow",
      "roadStraightArrow.obj",
      "roadStraightArrow.mtl",
    );
    ...
    this.load.obj(
      ...
      "roadCornerLargeBorder.obj",
      "roadCornerLargeBorder.mtl",
    );
    this.load.obj(
      "roadCornerLargeBorderInner",
      "roadCornerLargeBorderInner.obj",
      "roadCornerLargeBorderInner.mtl",
    );
  }
  ...
  create() {
    ...
    this.t = this.add
      .text(16, 16, "", { font: "16px Courier", fill: "#ffffff" })
      .setShadow(1, 1, "#000000");
  }
