class Example extends Phaser.Scene {
  ...
  create() {
    ...
    const text1 = this.add.text(20, 50, "Shadow Stroke", {
    ...
    const text2 = this.add.text(20, 180, "Shadow Fill", {
      fontFamily: "Arial Black",
      fontSize: 74,
      color: "#00a6ed",
    });
    ...
    const text3 = this.add.text(20, 310, "Shadow Both", {
      fontFamily: "Arial Black",
      fontSize: 74,
      color: "#00a6ed",
    });
    ...
    const text4 = this.add.text(20, 440, "Shadow None", {
      fontFamily: "Arial Black",
      fontSize: 74,
      color: "#00a6ed",
    });
