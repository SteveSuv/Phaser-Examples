class Example extends Phaser.Scene {
  ...
  preload() {
    this.load.atlas(
      "sf2",
      "assets/animations/sf2.png",
      "assets/animations/sf2.json",
    );
  }
  ...
  create() {
    var animConfig = {
      key: "ryu",
      frames: this.anims.generateFrameNames("sf2", {
        prefix: "frame_",
        end: 22,
      }),
      frameRate: 20,
    ...
    const sprite = this.add
      .sprite(550, 600, "sf2", "frame_0")
      .setOrigin(0.5, 1)
      .setScale(2);

    const text = this.add.text(32, 32, "Click to Start Animation", {
      color: "#00ff00",
    });
