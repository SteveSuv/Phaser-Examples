class Example extends Phaser.Scene {
  ...
  create() {
    ...
    const zone1 = this.add
      .zone(0, 0, 345, 300)
      .setOrigin(0)
      .setName("Plain")
      .setInteractive();
    const zone2 = this.add
      .zone(345, 0, 310, 300)
      .setOrigin(0)
      .setName("Chocolate")
      .setInteractive();
    const zone3 = this.add
      .zone(655, 0, 369, 300)
      .setOrigin(0)
      .setName("Coffee\nand cream")
      .setInteractive();

    const zone4 = this.add
      .zone(0, 300, 330, 300)
      .setOrigin(0)
      .setName("Chocolate\nSprinkles")
      .setInteractive();
    const zone5 = this.add
      .zone(330, 300, 350, 300)
      .setOrigin(0)
      .setName("Strawberry")
      .setInteractive();
    const zone6 = this.add
      .zone(680, 300, 344, 300)
      .setOrigin(0)
      .setName("More\nSprinkles")
      .setInteractive();
