class Example extends Phaser.Scene {
  ...
  create() {
    ...
    this.text = this.add.text(10, 10, "Use up to 4 fingers at once", {
      font: "16px Courier",
      fill: "#00ff00",
    });
  }
  ...
  update() {
    if (
      ...
      this.input.pointer3.isDown ||
      this.input.pointer4.isDown
    ) {
      this.graphics.clear();
    }
    ...
    this.graphics.fillRect(
      this.input.pointer3.x,
      this.input.pointer3.y,
      64,
      64,
    );
    ...
    this.graphics.fillRect(
      this.input.pointer4.x,
      this.input.pointer4.y,
      64,
      64,
    );
  }
