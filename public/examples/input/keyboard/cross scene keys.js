function createSpeechBubble(scene, x, y, width, height, quote) {
  ...
  var content = scene.add.text(0, 0, quote, {
    fontFamily: "Arial",
    fontSize: 20,
    color: "#000000",
    align: "center",
...
class SceneA extends Phaser.Scene {
  ...
  create() {
    let jelly = this.add
      .image(150, 500, "jellies", "WithShadow/Jelly1")
      .setScale(0.5);
    ...
    let bubble3 = createSpeechBubble(
      this,
      20,
      290,
      220,
...
class SceneB extends Phaser.Scene {
  ...
  create() {
    let jelly = this.add
      .image(400, 500, "jellies", "WithShadow/Jelly2")
      .setScale(0.5);
    let bubble1 = createSpeechBubble(
      this,
      290,
...
class SceneC extends Phaser.Scene {
  ...
  create() {
    let jelly = this.add
      .image(650, 500, "jellies", "WithShadow/Jelly3")
      .setScale(0.5);
    let bubble1 = createSpeechBubble(
      this,
      560,
