class Example extends Phaser.Scene {
  preload() {
    this.load.atlas(
      "jellies",
      "assets/atlas/jellies.png",
      "assets/atlas/jellies.json",
    );
  }

  create() {
    const jelly1 = this.add
      .image(150, 400, "jellies", "WithShadow/Jelly1")
      .setScale(0.5);
    const jelly2 = this.add
      .image(400, 400, "jellies", "WithShadow/Jelly2")
      .setScale(0.5);
    const jelly3 = this.add
      .image(650, 400, "jellies", "WithShadow/Jelly3")
      .setScale(0.5);

    const bubble1 = this.createSpeechBubble(
      20,
      180,
      220,
      80,
    ...
    const bubble2 = this.createSpeechBubble(
      290,
      180,
      220,
      80,
    ...
    const bubble3 = this.createSpeechBubble(
      560,
      180,
      220,
      80,
    ...
    this.add
      .text(10, 10, "Press the SPACE BAR", {
        font: "16px Courier",
        fill: "#ffffff",
      })
      .setShadow(1, 1);
