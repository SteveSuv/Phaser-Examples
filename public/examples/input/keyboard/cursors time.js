class Example extends Phaser.Scene {
  ...
  create() {
    ...
    this.leftKeyDebug = this.add.text(10, 300, "Left", {
      font: "16px Courier",
      fill: "#00ff00",
    });
    this.rightKeyDebug = this.add.text(570, 300, "Right", {
      font: "16px Courier",
      fill: "#00ff00",
    });
    this.upKeyDebug = this.add.text(300, 10, "Up", {
      font: "16px Courier",
      fill: "#00ff00",
    });
    this.downKeyDebug = this.add.text(300, 530, "Down", {
      font: "16px Courier",
      fill: "#00ff00",
    });
  }
