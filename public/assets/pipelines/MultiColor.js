...
const grayUniforms = ["uProjectionMatrix", "uMainSampler", "uGray"];
...
const hueUniforms = ["uProjectionMatrix", "uMainSampler", "uTime", "uSpeed"];

export default class MultiColorPipeline extends Phaser.Renderer.WebGL.Pipelines
  .MultiPipeline {
  constructor(game) {
    super({
      game,
