...
(function () {
  ...
  var SIDPlayerPlugin = function (pluginManager) {
    ...
    if (typeof jsSID_audioCtx.createJavaScriptNode === "function") {
      var jsSID_scriptNode = jsSID_audioCtx.createJavaScriptNode(
        bufferlen,
        0,
        1,
      );
    } else {
      var jsSID_scriptNode = jsSID_audioCtx.createScriptProcessor(
        bufferlen,
        0,
        1,
      );
        ...
        if (wf & NOISE_BITMASK) {
          ...
          if (wf == PULSE_BITMASK) {
            ...
            if (wf & TRI_BITMASK) {
              ...
              wfout = wfout
                ? combinedWF(channel, PulseSaw_8580, tmp >> 4, 1)
                : 0;
            //pulse+saw
          }
        } else if (wf & SAW_BITMASK) {
  ...
  SIDPlayerPlugin.prototype = Object.create(
  ...
  if (typeof exports !== "undefined") {
    ...
    define(
      "SIDPlayerPlugin",
      (function () {
        return (root.SIDPlayerPlugin = SIDPlayerPlugin);
      })(),
    );
  } else {
